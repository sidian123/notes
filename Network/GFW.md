...
修改hosts的方案早已失效, 目前主要使用代理

* Shadowsocks 貌似已经被GFW2识别出来了, 一旦重大节日, 这批代理首先被封
* VPN, 只能全局代理, 国内较慢
* SSH动态代理, 配合SwitchyOmega也挺好用的, 关键全程加密, 安全的同时也降低了吞吐量.

不管怎样, 都会有被封的可能, 为了进一步防止服务器被封, 有大佬提出方案: *服务器主动屏蔽北京的IP ,让扫描器扫不到你*
