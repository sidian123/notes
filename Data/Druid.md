...
Druid内置了监控的过滤器`StatFilter`, 可自定义监控数据的处理方式, 见 [保存Druid的监控记录](https://www.cnblogs.com/wanghuijie/p/druid_stat_log.html)
...
* [保存Druid的监控记录](https://www.cnblogs.com/wanghuijie/p/druid_stat_log.html) 自定义存储过滤器stat的监控内容的
* [DruidDataSource配置属性列表](https://github.com/alibaba/druid/wiki/DruidDataSource%E9%85%8D%E7%BD%AE%E5%B1%9E%E6%80%A7%E5%88%97%E8%A1%A8) 数据源配置属性
* [使用druid的监控组件进行数据库连接池的监控](https://www.jianshu.com/p/5ccbd10145cc) stat统计的一些字段含义